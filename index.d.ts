...
/**
* Interface for generating pseudorandom numbers drawn from a binomial distribution with pre-specified parameter values.
*/
...
/**
* Interface for generating pseudorandom numbers drawn from a binomial distribution without pre-specified parameter values.
*/
interface TernaryFunction extends PRNG {
	...
	* @returns output array
	*/
	( len: number, n: number, p: number, options?: Options ): RandomArray;
	...
	* @returns output array
	*/
	assign( n: number, p: number, out: RandomArray ): RandomArray;
}
...
interface Random extends PRNG {
	...
	* // returns <Float64Array>
	*/
	factory( n: number, p: number, options?: FactoryOptions ): UnaryFunction;
