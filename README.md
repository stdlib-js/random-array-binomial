...
```javascript
binomial = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-binomial@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-array-binomial/tags). For example,

```javascript
binomial = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-array-binomial@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var binomial = require( 'path/to/vendor/umd/random-array-binomial/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-array-binomial@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/random-array-binomial/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/random-array-binomial/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/random-array-binomial.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-array-binomial/main
